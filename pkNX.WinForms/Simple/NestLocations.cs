namespace pkNX.WinForms.Simple
{
    ...
    public static class NestLocations
    {
        ...
        public static string GetLocations(int indx)
        {
            var locationStrings = Properties.Resources.locations_zh.Split('\n');
            return locationStrings[indx];
        }
        ...
        internal static ulong getEventHash(int raidParametersIndex)
        {
            if (raidParametersIndex >= 183) return EventHash_Rigel2;
            if (raidParametersIndex >= 100) return EventHash_Rigel1;
            return EventHash;
        }
    }
}
